...
def alpamayo(started: bool, params: Params, CP: car.CarParams) -> bool:
  return started and params.get_bool("AlpamayoEnabled")
...
procs = [
  ...
  PythonProcess("alpamayod", "selfdrive.alpamayo.alpamayod", alpamayo),
